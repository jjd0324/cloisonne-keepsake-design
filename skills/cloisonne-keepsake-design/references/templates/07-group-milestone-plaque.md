...
```text
将参考图中的【2–4 位人物】、【从左到右的顺序】、【相互距离和互动关系】、【服饰主色】、【手势或姿态】以及【一个代表性的背景元素】转译为一件真实的横向圆角掐丝珐琅桌面纪念牌。严格保留人物数量、左右顺序、身高关系和主要服饰轮廓；面部细节不清楚时，优先保留发型、姿势和关系感，不凭空增加可识别身份特征或人物。
...
- 如需纪念日期或姓名，先让用户单独提供文字与排版要求，不从照片中臆测。
